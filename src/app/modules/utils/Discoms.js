...
import {
  ...
  export const STATE_URL = `${process.env.REACT_APP_ADMIN_API_URL}/api/getDiscomDropDownData`;

class Discoms extends Component {
   constructor(props) {
	super(props);
	this.state = {
		countries: [],
...
render() {
	...
	return (
		<div>
		  <Select name="discomName" label="Discom Name" id="discom"  onChange={this.props.getRegion} >

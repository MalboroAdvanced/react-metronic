...
export function AgreementviewForm({
  saveAgreement,
  getRegionForState,
  agreement,
  actionsLoading,
            ...
            <Modal.Body className="overlay overlay-block cursor-default">
              ...
              <div className="form-group row">
                 ...
                 <div className="col-lg-4">
                   <InputLabel name="stratDate"  label="Start Date">Start Date:<b>&nbsp;{agreement.stratDate}</b></InputLabel>
                  ...
                  <div className="col-lg-4">
                  <InputLabel name="stratDate"  label="Start Date">End Date:<b>&nbsp;{agreement.endDate}</b></InputLabel>
                    {/* <DatePickerField
                      name="endDate"
                      label="End Date"
                  ...
                  <div className="form-group row">
                  <div className="col-lg-4">
                  <InputLabel name="stratDate"  label="Start Date">Seller Portfolio:<b>&nbsp;{agreement.sellerportfolio}</b></InputLabel>
...
{fill()}
   ...
   {/* <Portfolios />  */}
                 {/* </Select> */}
                  ...
                  <div className="col-lg-4">
                  <InputLabel>Buyer Portfolio:<b>&nbsp;{agreement.buyerportfolio}</b></InputLabel>
                ...
                {/* </Select>  */} 
                  ...
                  <div className="form-group row">
                  <div className="col-lg-4">
                  <InputLabel>Application No:<b>&nbsp;{agreement.applicationNo}</b></InputLabel>
                    {/* <Field
                      name="applicationNo"
                      component={Input}
                  ...
                  <InputLabel >Approval No.:<b>&nbsp;{agreement.approvalNo}</b></InputLabel>
                  ...
                  <InputLabel>Contract Type:<b>&nbsp;{agreement.contractType}</b></InputLabel>
                ...
                {/* <Select name="contractType" label="Applied In">
                 {CONTRACT_TYPE.map((contractType) => (
                  ...
                  <InputLabel >Transation Type:<b>&nbsp;{agreement.transactionType}</b></InputLabel> 
                 ...
                 {TRANSACTION_TYPE.map((transactionType) => (
                  ...
                  <div className="col-lg-4">
                  <InputLabel >1oi Unique No:<b>&nbsp;{agreement.loiUniqueNo}</b></InputLabel>
                    {/* <Field
                      name="loiUniqueNo"
                      component={Input}
    ...
    {/* Route */}
                  <div className="form-group row">
                  <div className="col-lg-4">
                  <InputLabel >First Route:<b>&nbsp;{agreement.firstRoute}</b></InputLabel>
                 ...
                 {REGIONTYPE.map((pointOfConnection) => (
                  ...
                  <div className="col-lg-4">
                  <InputLabel >Second Route:<b>&nbsp;{agreement.secondRoute}</b></InputLabel>
                 ...
                 {REGIONTYPE.map((pointOfConnection) => (
                  ...
                  <InputLabel >Third Route:<b>&nbsp;{agreement.thirdRoute}</b></InputLabel>
                 ...
                 {/*  <div className="col-lg-4">
                  ...
                  {/* SLDC */}
                  <div className="col-lg-4">
                  <InputLabel >States:<b>&nbsp;{agreement.stateid}</b></InputLabel>
                    {/* <States/> */}
                  </div>
                  {/* Last Name */}
                  <div className="col-lg-4">
                  ...
                  <InputLabel >Billing Head:<b>&nbsp;{agreement.bullingHead}</b></InputLabel>
                 ...
                 {BILLING_HEAD.map((bullingHead) => (
                  ...
                  <InputLabel >States Region:<b>&nbsp;{agreement.getRegion}</b></InputLabel>
               {/* <States getRegion={getRegion}/> */}
                ...
                <InputLabel >delivery Point:<b>&nbsp;{agreement.deliveryPoint}</b></InputLabel>
                {/* <Select name="deliveryPoint" label="Delivery Point*">
                 ...
                 {DELIVERY_POINT.map((deliveryPoint) => (
                  ...
                  <InputLabel >Tarrif At DeliveryPoint:<b>&nbsp;{agreement.tarrifAtDeliveryPoint}</b></InputLabel>
                  {/* <Field
...
<InputLabel >Provision BillingCycle:<b>&nbsp;{agreement.provisionbillingcycle}</b></InputLabel>
                  {/* <Field
                  component={Input}
                  ...
                  <div className="col-lg-4">
                  <InputLabel >DueDate:<b>&nbsp;{agreement.dueDate}</b></InputLabel>
                  {/* <DatePickerField
                      name="dueDate"
                      label="Due Date"
                  ...
                  <div className="form-group row">
                    ...
                    <InputLabel >Final Billing Cycle:<b>&nbsp;{agreement.finalBillingCycle}</b></InputLabel>
                 ...
                 {PROVISIONAL_BILLING_CYCLE.map((finalBillingCycle) => (
                  ...
                  <div className="col-lg-4">
                  <InputLabel >Margin:<b>&nbsp;{agreement.margin}</b></InputLabel>
                  {/* <Field
                      name="margin"
                      component={Input}
...
<InputLabel >Rebate:<b>&nbsp;{agreement.rebate}</b></InputLabel>
                  {/* <Field
                      name="rebate"
                      component={Input}
                      placeholder="Rebate (%)"
                    ...
                    <div className="col-lg-4">
                    <InputLabel >Billing Source:<b>&nbsp;{agreement.billingSource}</b></InputLabel>
                 ...
                 {BILLING_SOURCE.map((billingSource) => (
                  ...
                  <div className="form-group row">
<div className="col-lg-4">
<InputLabel >CompensationRate:<b>&nbsp;{agreement.compensationRate}</b></InputLabel>
{/* <Field
                  ...
                  {/* Date of birth */}
                  <div className="col-lg-4">
                  <InputLabel >Compensation Percent:<b>&nbsp;{agreement.compensationPercent}</b></InputLabel>
                  {/* <Field
...
<Field
                  ...
                  <div className="col-lg-4">
                  <InputLabel >surCharge:<b>&nbsp;{agreement.surcharge}</b></InputLabel>
                  {/* <Field
                      name="surcharge"
                      component={Input}

...
export function AgreementviewDialogHeader({ agreementMasterId }) {
  ...
  useEffect(() => {
    ...
    let _title = agreementMasterId ? "" : "View Agreement";
    if (agreementForEdit && agreementMasterId) {
      // console.log("hukum",agreementMasterId)
      _title = `View Agreement '${agreementForEdit.contractno}'`;
    }
